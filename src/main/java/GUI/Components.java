...
//        componentType.setFont(new Font("Arial", Font.PLAIN, 14));
//
//        // Добавление компонентов
//        gbc.gridx = 0;
//        gbc.gridy = 1;
//        contentPanel.add(new JLabel("Наименование:"), gbc);
//
//        gbc.gridx = 1;
...
//        gbc.gridx = 0;
//        gbc.gridy = 2;
//        contentPanel.add(new JLabel("Тип компонента:"), gbc);
//
//        gbc.gridx = 1;
//        contentPanel.add(componentType, gbc);
//
//        gbc.gridx = 0;
//        gbc.gridy = 3;
//        contentPanel.add(new JLabel("Количество:"), gbc);
//
//        gbc.gridx = 1;
